...
#define REGW_FLAGS					0 /* 1=periodic_trig_en 2=self  3=en_int_trig  4=ext 5=trig_ta 0=is_started*/
...
#define REGR_TLAST_CNT2				16 /*total number of TLASTs which has been sent*/
