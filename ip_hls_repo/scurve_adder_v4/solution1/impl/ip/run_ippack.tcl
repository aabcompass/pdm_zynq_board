...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS in_stream0 in_stream1 in_stream2 in_stream3 in_stream4 in_stream5 out_stream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 5.000000 machine 64 combinational 0 latency 204 II x}
...
set enable_xo_gen 0
set kernel_files {/home/fran/xil_proj/scurve_adder/cpp_code/v4/scurve_adder.cpp}
if {$enable_xo_gen} {
