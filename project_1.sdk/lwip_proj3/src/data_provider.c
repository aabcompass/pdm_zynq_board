...
{
	int i;
//	*(u32*)(XPAR_AXI_DATA_PROVIDER_0_BASEADDR + 4*REGW_LOAD_PIX_MASK) = BIT_PIX_DISCARD | 10*BIT_PIX_NUM | 0*BIT_ECASIC_LINE | BIT_PIX_WR;
//	*(u32*)(XPAR_AXI_DATA_PROVIDER_0_BASEADDR + 4*REGW_LOAD_PIX_MASK) = BIT_PIX_DISCARD | 20*BIT_PIX_NUM | 1*BIT_ECASIC_LINE | BIT_PIX_WR;
//	*(u32*)(XPAR_AXI_DATA_PROVIDER_0_BASEADDR + 4*REGW_LOAD_PIX_MASK) = BIT_PIX_DISCARD | 30*BIT_PIX_NUM | 2*BIT_ECASIC_LINE | BIT_PIX_WR;
//	*(u32*)(XPAR_AXI_DATA_PROVIDER_0_BASEADDR + 4*REGW_LOAD_PIX_MASK) = BIT_PIX_DISCARD | 40*BIT_PIX_NUM | 3*BIT_ECASIC_LINE | BIT_PIX_WR;

	for(i=0;i<2304/6/2;i+=5)
		*(u32*)(XPAR_AXI_DATA_PROVIDER_0_BASEADDR + 4*REGW_LOAD_PIX_MASK) = BIT_PIX_DISCARD | i*BIT_PIX_NUM | 4*BIT_ECASIC_LINE | BIT_PIX_WR;
//	for(i=0;i<2304/6;i+=6)
//		*(u32*)(XPAR_AXI_DATA_PROVIDER_0_BASEADDR + 4*REGW_LOAD_PIX_MASK) = BIT_PIX_DISCARD | i*BIT_PIX_NUM | 5*BIT_ECASIC_LINE | BIT_PIX_WR;
}
